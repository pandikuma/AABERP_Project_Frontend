...
const History = ({ username, userRoles = [], viewMode = 'default' }) => {
    ...
    const [overallPaymentsSearch, setOverallPaymentsSearch] = useState('');
    ...
    const filteredPayments = payments.filter((row) => {
        ...
        if (selectPaymentType) {
            if (row.type?.toLowerCase() !== selectPaymentType.toLowerCase()) return false;
        }
        if (!overallPaymentsSearch.trim()) return true;
        const q = overallPaymentsSearch.toLowerCase().trim();
        const searchable = [
    ...
    return (
        <body className="bg-[#FAF6ED] overflow-hidden">
            <div className={isExpensesEntryUploadOnly ? 'flex flex-col h-[calc(100vh-104px)] overflow-hidden bg-[#FAF6ED] px-[18px] pt-[18px] pb-[18px]' : 'flex flex-col h-[calc(100vh-104px)] overflow-hidden bg-[#FAF6ED] px-[18px] pt-[18px] pb-[18px]'}>
                <div className={isExpensesEntryUploadOnly ? 'flex flex-col flex-1 min-h-0 overflow-hidden bg-[#FAF6ED]' : 'flex flex-col flex-1 min-h-0 overflow-hidden bg-[#FAF6ED]'}>
                    <div className={isExpensesEntryUploadOnly
                        ...
                        {!isExpensesEntryUploadOnly && (
                            <div className="flex justify-end mb-[18px] items-center gap-6 flex-wrap">
                                        ...
                                        {selectedWeek && !weeklySummaryLoading && !weeklySummaryFile && (
                                            <>
                                                ...
                                                >
                                                    ...
                                                    {weeklySummaryUploading ? "Uploading…" : "Signature Copy"}
                                                </button>
                                            </>
                                        )}
                                    </div>
                    ...
                    {!isExpensesEntryUploadOnly && (
                        <div className="flex justify-end mb-[18px] shrink-0">
                    ...
                    <div className={isExpensesEntryUploadOnly
                        ...
                        : 'w-full pt-[18px] px-[18px] pb-[18px] bg-white rounded-[6px] flex flex-col flex-1 min-h-0 overflow-hidden'}>
                        <div className={`text-left ${isExpensesEntryUploadOnly
                        ...
                        <div className="flex flex-col min-[1500px]:flex-row gap-[18px] flex-1 min-h-0 overflow-y-auto min-[1500px]:overflow-hidden">
                            <div className={`min-w-0 ${isExpensesEntryUploadOnly ? 'w-full flex flex-col flex-1 min-h-0 overflow-hidden' : 'w-full min-[1500px]:w-fit max-w-full shrink-0 flex flex-col min-h-0 overflow-hidden'}`}>
                                {!isExpensesEntryUploadOnly && (
                                    <>
                                        <div className="w-[1174px] max-w-full shrink-0">
                                            <div className="flex justify-between items-center mb-2">
                                                <h1 className="font-bold text-base">
                                                    Expenses{selectedWeek ? ` (PS ${selectedWeek})` : ''}
                                                </h1>
                                                <span className="font-bold text-base" style={{ color: '#E4572E' }}>
                                                    ₹{filteredExpenses.reduce((total, expense) => total + Number(expense.amount || 0), 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                                </span>
                                            </div>
                                            <div className={`text-left flex mb-[12px] gap-[6px] w-full ${(selectDate || selectContractororVendorName || selectProjectName || selectType)
                                ...
                                <div className={isExpensesEntryUploadOnly ? 'flex flex-col flex-1 min-h-0' : 'w-fit flex-1 min-h-0 rounded-lg border-l-8 border-l-[#BF9853] overflow-hidden'}>
                                    <div
                                        ref={scrollRef}
                                        className={isExpensesEntryUploadOnly
                                            ? 'w-fit rounded-lg border border-gray-200 border-l-8 border-l-[#BF9853] flex-1 min-h-0 overflow-auto select-none scrollbar-none no-scrollbar'
                                            : 'w-fit max-w-full overflow-auto no-scrollbar h-full'}
                                    ...
                                    >
                                        {isExpensesEntryUploadOnly ? (
                                            ...
                                            <table className={`border-collapse text-left w-[1174px] min-w-[1174px] max-w-[1174px] table-fixed ${EDBC_TABLE_EDGE_TABLE_CLASS}`}>
                                                <colgroup>
                                                    <col style={{ width: '70px', minWidth: '70px', maxWidth: '70px' }} />
                                                    <col style={{ width: '120px', minWidth: '120px', maxWidth: '120px' }} />
                                                    <col style={{ width: '218px', minWidth: '218px', maxWidth: '218px' }} />
                                                    <col style={{ width: '298px', minWidth: '298px', maxWidth: '298px' }} />
                                                    <col style={{ width: '158px', minWidth: '158px', maxWidth: '158px' }} />
                                                    <col style={{ width: '120px', minWidth: '120px', maxWidth: '120px' }} />
                                                    <col style={{ width: '120px', minWidth: '120px', maxWidth: '120px' }} />
                                                    <col style={{ width: '70px', minWidth: '70px', maxWidth: '70px' }} />
                                                </colgroup>
                                                <thead className="sticky top-0 z-10 bg-white">
                                                    <EdbcTableHeaderRow>
                                                        ...
                                                        <EdbcColumnHeader columnId={EDBC_IDS.EDBC12} label="Type" />
                                                        <EdbcColumnHeader columnId={EDBC_IDS.EDBC8} label="Amount" />
                                                        <th className="w-[120px] font-bold"></th>
                                                    ...
                                                    {!isExpensesEntryUploadOnly && canEditSelectedWeek ? (
                                                        <tr className="bg-white border-b border-gray-200">
                                                            <td className=" w-[60px] font-bold">{filteredExpenses.length + 1}.</td>
                                                            <td className=" w-[120px]">
                                                                <CustomDateField
                                                                    value={newExpense.date}
                                                                    onChange={validateExpenseDate}
                                                                    placeholder="Date"
                                                                    alwaysOpenBelow
                                                                    controlHeightPx={38}
                                                                    className="w-[120px] [&>div]:!w-full [&>div]:!h-[38px] [&>div]:!border-2 [&>div]:!border-[rgba(191,152,83,0.2)] [&>div]:!rounded-lg [&>div]:!shadow-none [&>div]:!text-[14px] [&>div:hover]:!border-[rgba(191,152,83,0.4)] [&>div:focus-within]:!border-[rgba(191,152,83,0.4)] [&>div:focus-within]:!shadow-[0_0_0_1px_rgba(191,152,83,0.4)]"
                                                                />
                                                            </td>
                                                            <td className=" w-[218px]">
                                                                <div className="flex items-center gap-1 w-[218px] min-w-[218px] max-w-[218px] shrink-0">
                                                                    <div className="flex-1 min-w-0">
                                                                        <Select
                                                                            name="contractor"
                                                                            className="w-full min-w-0 shrink text-xs focus:outline-none"
                                                                            value={
                                                                            ...
                                                                            styles={{
                                                                                ...
                                                                                valueContainer: (provided) => ({
                                                                                    ...DATABASE_TABLE_FILTER_SELECT_STYLES.valueContainer(provided),
                                                                                    flexWrap: 'nowrap',
                                                                                }),
                                                                                input: (provided) => ({
                                                                                    ...provided,
                                                                                ...
                                                                                singleValue: (provided) => ({
                                                                                    ...DATABASE_TABLE_FILTER_SELECT_STYLES.singleValue(provided),
                                                                                    maxWidth: '100%',
                                                                                    overflow: 'hidden',
                                                                                    textOverflow: 'ellipsis',
                                                                                    whiteSpace: 'nowrap',
                                                                    ...
                                                                    <button type="button" className="shrink-0" onClick={handlePartySourceToggle} >
                                                                        <img
                                                                            src={Change}
                                                            ...
                                                            <td className="w-[298px]">
                                                                <Select
                                                                    name="project"
                                                                    className="w-[298px] min-w-[298px] max-w-[298px] shrink-0 text-xs focus:outline-none"
                                                                    isClearable
                                                            ...
                                                            <td className=" w-[158px]">
                                                                <Select
                                                                    name="type"
                                                                    className="w-[158px] min-w-[158px] max-w-[158px] shrink-0 text-xs focus:outline-none"
                                                                    value={
                                                                        newExpense.type
                                                                            ? { value: newExpense.type, label: newExpense.type }
                                                                            : null
                                                                    }
                                                                    onChange={(selectedOption) => {
                                                                        handleInputChange({
                                                            ...
                                                            <td className=" w-[120px] pr-[9px]">
                                                                <input
                                                                    type="number"
                                                                    name="amount"
                                                                    className="box-border rounded-lg border-2 border-[rgba(191,152,83,0.2)] bg-white w-[120px] h-[38px] pl-3 text-[14px] font-normal text-black outline-none hover:border-[rgba(191,152,83,0.4)] focus:border-[rgba(191,152,83,0.4)] focus:shadow-[0_0_0_1px_rgba(191,152,83,0.4)] no-spinner"
                                                            ...
                                                            <td className="w-[120px] bg-white"></td>
                                                            <td className="w-[70px] bg-white"></td>
                                                        </tr>
                                                    ) : null}
                                                </thead>
                                                <tbody>
                                                    {[...filteredExpenses].reverse().map((row, index) => (
                                                        <EdbcTableBodyRow key={row.id}>
                                                            ...
                                                            {editingRowId === row.id ? (
                                                                <td id={EDBC_IDS.EDBC19} className={getEdbcColumnConfig(EDBC_IDS.EDBC19)?.tdClass}>
                                                                ...
                                                                <EdbcActivityBodyCell
                                                                    ...
                                                                    onEdit={(expense) => {
                                                                        ...
                                                                        setEditingOriginalRow({ ...expense });
                                                                    }}
                                                                    onDelete={(id) => handleWeeklyExpensesDelete(id)}
                                                                    onHistory={fetchAuditDetailsForExpense}
                                                                    username={resolveEnteredBy()}
                                                                />
                                                            ) : (
                                                                <td id={EDBC_IDS.EDBC19} className={getEdbcColumnConfig(EDBC_IDS.EDBC19)?.tdClass} />
                                                            )}
                            ...
                            {!isExpensesEntryUploadOnly && (
                                <div className="w-fit shrink-0 min-[1500px]:flex-1 min-w-0 flex flex-col min-h-0 overflow-hidden isolate">
                                    <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
                                        <div className="flex justify-between items-center shrink-0 mb-2">
                                            <h1 className="font-bold text-base shrink-0">Income</h1>
                                            <span className="font-bold text-base text-[#E4572E]">
                                                ₹{filteredPayments.reduce((total, row) => total + Number(row.amount || 0), 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                            </span>
                                        </div>
                                        <div className={`text-left flex shrink-0 mb-[12px] gap-[6px] ${(selectPaymentDate || selectPaymentType)
                                            ? 'flex-col sm:flex-row sm:justify-between'
                                            : 'flex-row justify-between items-center'
                                            }`}>
                                            <div className="flex flex-row items-center sm:space-x-3 min-w-0 flex-1 overflow-hidden">
                                                <button onClick={() => setShowPaymentsFilters(!showPaymentsFilters)}>
                                                    <img
                                                        src={TableFilter}
                                                        alt="Toggle Filter"
                                                        className="border rounded-md"
                                                ...
                                                {(selectPaymentDate || selectPaymentType) && (
                                                    <div className="flex flex-row flex-wrap items-center gap-2 min-w-0">
                                                        {selectPaymentDate && (
                                                            <span className="inline-flex items-center gap-1 border text-[#000000] border-[#a1a1a1] h-[34px] rounded px-2 text-sm font-medium w-fit">
                                                                <span className="font-medium text-[#BF9853]">Date: </span>
                                            ...
                                            <div className="flex items-end gap-[6px] shrink-0">
                                                <button onClick={clearPaymentsSearch} className="flex h-[30px] w-[30px] shrink-0 items-center justify-center">
                                                    <img className="w-full h-full" src={Reload} alt="Reload" />
                                                </button>
                                                <div className="w-[286px] min-w-[286px] shrink-0 h-[34px] border border-[#D6D6D6] rounded-md bg-white flex items-center px-2 gap-1">
                                                    <input
                                                        type="text"
                                                        value={overallPaymentsSearch}
                                                        onChange={(e) => setOverallPaymentsSearch(e.target.value)}
                                                        placeholder="Search Transactions..."
                                                        className="h-full w-full border-0 p-0 text-[14px] text-[#000000] bg-transparent outline-none"
                                                    />
                                                    <img src={Search} alt="Search" className="w-[16px] h-[16px] pointer-events-none" />
                                        ...
                                        <div className=" flex-1 min-h-[240px] rounded-lg border-l-8 border-l-[#BF9853] overflow-hidden">
                                        <div ref={paymentsScrollRef} className=" h-full overflow-y-auto no-scrollbar"
                                            style={{
                                        ...
                                        >
                                            <table className={` border-collapse ${EDBC_TABLE_EDGE_TABLE_CLASS}`}>
                                                <thead className="sticky top-0 z-10 bg-white">
                                                    <EdbcTableHeaderRow>
                                                        <EdbcColumnHeader columnId={EDBC_IDS.EDBC2} label="Date" />
                                                        <EdbcColumnHeader columnId={EDBC_IDS.EDBC8} label="Amount" />
                                                        <EdbcColumnHeader columnId={EDBC_IDS.EDBC13} label="Type" />
                                                        <EdbcColumnHeader columnId={EDBC_IDS.EDBC19} label="Activity" />
                                                    </EdbcTableHeaderRow>
                                                    {showPaymentsFilters && (
                                                        <EdbcTableFilterRow>
                                                            ...
                                                            />
                                                            <EdbcEmptyFilterCell columnId={EDBC_IDS.EDBC8} />
                                                            <EdbcSelectFilter
                                                ...
                                                <tbody>
                                                    {filteredPayments.map((row, index) => (
                                                        <EdbcTableBodyRow key={index}>
                                                            {editingPaymentId === (row.id || null) ? (
                                                                <td id={EDBC_IDS.EDBC2} className={getEdbcColumnConfig(EDBC_IDS.EDBC2)?.tdClass}>
                                                                    <input
                                                                        ...
                                                                        className="border-2 border-[#BF9853] border-opacity-25 p-1 rounded-lg bg-transparent w-[120px] h-[38px] focus:outline-none"
                                                                    />
                                                                </td>
                                                            ) : (
                                                                <EdbcDateBodyCell
                                                                ...
                                                                <div className="min-w-0 flex-1 text-right pr-1">
                                                                    {editingPaymentId === (row.id || null) ? (
                                                                        <input
                                                                            ...
                                                                            className="border-2 border-[#BF9853] border-opacity-25 rounded-lg bg-transparent w-[120px] h-[38px] focus:outline-none no-spinner ml-auto block"
                                                                            onWheel={(e) => e.preventDefault()}
                                                                            onFocus={() =>
                                                            ...
                                                            {editingPaymentId === (row.id || null) ? (
                                                                <td id={EDBC_IDS.EDBC13} className={getEdbcColumnConfig(EDBC_IDS.EDBC13)?.tdClass}>
                                                                    <select
                                                                        value={row.type || ""}
                                                                        onChange={(e) =>
                                                                            handleEditPayment(index, "type", e.target.value)
                                                                        }
                                                                        className="border-2 border-[#BF9853] border-opacity-25 w-[120px] h-[38px] rounded-lg bg-transparent focus:outline-none"
                                                                ...
                                                                <EdbcExpandableBodyCell
                                                                    ...
                                                                    expandedCells={expandedCells}
                                                                    onToggleExpanded={toggleExpandedCell}
                                                                    getDisplayValue={(expense) => expense.type}
                                                                />
                                                            )}
                                                            <td id={EDBC_IDS.EDBC19} className={getEdbcColumnConfig(EDBC_IDS.EDBC19)?.tdClass}>
                                                                {canEditSelectedWeek && (
                                                        ...
                                                        <EdbcTableBodyRow>
                                                            <td id={EDBC_IDS.EDBC2} className={getEdbcColumnConfig(EDBC_IDS.EDBC2)?.tdClass}>
                                                                <input
                                                                    type="date"
                                                                    name="date"
                                                                    className="border-2 border-[#BF9853] border-opacity-25 p-1 rounded-lg w-[120px] h-[38px] focus:outline-none"
                                                            ...
                                                            <td id={EDBC_IDS.EDBC8} className={getEdbcColumnConfig(EDBC_IDS.EDBC8)?.tdClass}>
                                                                <input
                                                                    type="number"
                                                                    name="amount"
                                                                    className="border-2 border-[#BF9853] border-opacity-25 rounded-lg w-[120px] h-[38px] focus:outline-none no-spinner ml-auto block"
                                                            ...
                                                            <td id={EDBC_IDS.EDBC13} className={getEdbcColumnConfig(EDBC_IDS.EDBC13)?.tdClass}>
                                                                <Select
                                                                    name="type"
                                                                    className="w-[120px] min-w-[120px] max-w-[120px] shrink-0 text-xs focus:outline-none"
                                                                    value={
                                                                        newPayment.type
                                                                            ? { value: newPayment.type, label: newPayment.type }
                                                                            : null
                                                                    }
                                                                    onChange={(selectedOption) => {
                                                                        handlePaymentChange({
                                                            ...
                                                            <td id={EDBC_IDS.EDBC19} className={getEdbcColumnConfig(EDBC_IDS.EDBC19)?.tdClass}></td>
                                                        </EdbcTableBodyRow>
                                                    ) : null}
                                                </tbody>
                                            </table>
                                        ...
                                        <div className="mt-[18px] shrink-0 max-h-[35vh] overflow-y-auto no-scrollbar">
                                            {(() => {
                                                ...
                                                const summaryTotal = summaryEntries.reduce(
                                                    (sum, [, total]) => sum + Number(total || 0),
                                                    0
                                                );
                                                const formatSummaryInr = (value) =>
                                                    `₹${Number(value).toLocaleString('en-IN', {
                                                        minimumFractionDigits: 2,
                                                        maximumFractionDigits: 2,
                                                    })}`;
                                                return (
                                                    <div className="rounded-xl border border-[#E5E7EB] bg-white text-left shadow-sm p-3 overflow-auto">
                                                        <div className="rounded-lg border border-[#E5E7EB] bg-white px-4 py-4 overflow-auto">
                                                            <div className="flex items-center justify-between gap-3 mb-4">
                                                                <h2 className="font-bold text-[16px] leading-tight text-black shrink-0">Summary Details</h2>
                                                                    ...
                                                                    {selectedWeek && !weeklySummaryLoading && !weeklySummaryFile && (
                                                                        <>
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                disabled={weeklySummaryUploading}
                                                                                onClick={() => weeklySummaryFileInputRef.current?.click()}
                                                                                className="inline-flex items-center gap-2 rounded-md border border-[#D1D5DB] bg-white px-4 py-2 text-[14px] font-semibold text-[#374151] disabled:opacity-50 shrink-0 hover:bg-gray-50"
                                                                                title="Upload Signature Copy for this week"
                                                                            >
                                                                                <span>{weeklySummaryUploading ? "Uploading…" : "Signature"}</span>
                                                                                <img src={fileUpload} alt="" className="w-[18px] h-[18px]" />
                                                                            </button>
                                                                        </>
                                                                    )}
                                                                </div>
                                                            ...
                                                            <div>
                                                                {summaryEntries.length === 0 ? (
                                                                    <p className="text-[14px] text-[#9CA3AF] py-2">No summary data for this week.</p>
                                                                ) : (
                                                                    <div className="space-y-1">
                                                                        {summaryEntries.map(([type, total]) => (
                                                                            ...
                                                                            >
                                                                                <span className="text-[14px] font-normal text-[#9CA3AF]">{type}</span>
                                                                                <span className="text-[14px] font-normal text-black tabular-nums">
                                                                                    {formatSummaryInr(total)}
                                                                                </span>
                                                                            </div>
                                                                        ))}
                                                                    </div>
                                                                )}
                                                                <div className="border-t border-dashed border-[#E5E7EB] my-3" />
