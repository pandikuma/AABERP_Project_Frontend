    ...
    <div className="modal-bg" onClick={onClose}>
      <div className="modal" onClick={e=>e.stopPropagation()}>
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div><div className="label-text mb-1">From</div><input type="date" className="input num-cell" value={from} onChange={e=>setFrom(e.target.value)}/></div>
          <div><div className="label-text mb-1">To</div><input type="date" className="input num-cell" value={to} onChange={e=>setTo(e.target.value)}/></div>
        </div>
      ...
      <div className="mob-cards px-3 pb-4 pt-2">
        {sortedRows.map((r,i)=>(
          <div key={r.id} className={`mob-card ${r.matched?'matched':''}`}>
            ...
            <div className="text-xs muted">{r.party} • {r.type}</div>
      ...
      <div className="modal text-left" onClick={e=>e.stopPropagation()}>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input type="date" className="input num-cell" value={dateISO} onChange={e=>setDateFromISO(e.target.value)}/>
          </div>
          <div>
          ...
          {f.mode==="Cheque" && <>
            ...
            <div>
              ...
              <input type="date" className="input num-cell" value={chequeDateISO} onChange={e=>setChequeDateFromISO(e.target.value)}/>
            </div>
          </>}
        </div>
  ...
  return (
    <div className="modal-bg" onClick={onClose}>
      <div className="modal text-left" onClick={e=>e.stopPropagation()}>
        ...
        <div className="text-xs muted mb-3">Account: <span className="font-semibold ink">{f.account}</span></div>
        <div className="grid grid-cols-2 gap-3">
          <div><div className="label-text mb-1">Date</div><input type="date" className="input num-cell" value={dateISO} onChange={e=>set("date", fromISO(e.target.value))}/></div>
...
const BankRegister6Inner = () => {
  ...
  const upiTotal = accountExpenses.filter(r=>["G-Pay","PhonePe","Paytm"].includes(r.mode)).reduce((s,r)=>s+r.amount,0);
  ...
  return (
    <div>
      <div className="shell">
        ...
        <div className="acct-stat-grid mb-5">
        ...
        {!account ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            ...
            <aside className={`lg:col-span-3 side-col ${sideOpen?'open':''}`}>
