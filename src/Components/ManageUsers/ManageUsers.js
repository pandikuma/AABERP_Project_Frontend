  ...
  return (
    <div className="p-4 sm:p-6 w-full max-w-[1750px] bg-white ml-0 md:ml-8 box-border">
      ...
      <div className="flex justify-between items-center flex-wrap gap-4 mb-7 mt-4">
        <div></div>
        <div>
          <button className="w-full sm:w-[132px] h-[38px] bg-[#BF9853] text-white font-semibold rounded" onClick={() => setShowModal(true)}>
            + New User
          </button>
        </div>
      </div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <div className="bg-white p-5 sm:p-7 rounded shadow-md w-full max-w-[441px] min-h-[415px] max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 text-left mb-4">
              <div className="flex-1 min-w-0">
                <label className="text-base font-semibold">Select Employee</label>
                <select className="w-full max-w-[198px] h-[45px] p-2 border-2 border-[#BF9853] border-opacity-20 rounded-lg focus:outline-none">
                  <option>Select Employee</option>
                </select>
              </div>
              <div className="flex-1 min-w-0">
                <label className="text-base font-semibold">Employee ID</label>
                <select className="w-full max-w-[147px] h-[45px] p-2 border-2 border-[#BF9853] border-opacity-20 rounded-lg focus:outline-none">
                  <option>ID</option>
                </select>
              </div>
            </div>
            <div className="mr-0 sm:mr-7 text-left">
              <div className="mb-4">
                <label className="text-base font-semibold">Create User ID</label>
                <input type="text" placeholder="Enter New User id" className="w-full max-w-[361px] h-[45px] p-2 border-2 border-[#BF9853] border-opacity-20 rounded-lg mt-1 focus:outline-none" />
              </div>
              <div className="mb-4">
                <label className="text-base font-semibold">Create Password</label>
                <input type="password" placeholder="Enter New Password" className="w-full max-w-[361px] h-[45px] p-2 border-2 border-[#BF9853] border-opacity-20 rounded-lg mt-1 focus:outline-none" />
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <div className="bg-white p-6 w-full max-w-[441px] min-h-[321px] shadow-lg relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-end gap-3 mt-6">
              ...
              <button onClick={() => {handleClose();}} className="bg-[#BF9853] w-[96px] h-[35px] text-white rounded" >
                Save
              </button>
            </div>
          </div>
      ...
      {showSuspendPopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <div className="bg-white p-6 w-full max-w-[405px] min-h-[262px] shadow-lg relative max-h-[90vh] overflow-y-auto">
            <button className="absolute top-3 right-3 text-red-500 text-xl font-bold" onClick={() => setShowSuspendPopup(false)}>
              X
            </button>
            ...
            <div className="flex justify-end gap-3">
              <button onClick={() => setShowSuspendPopup(false)} className="border w-[111px] h-[35px] border-[#BF9853] text-[#BF9853] rounded">
                Cancel
              </button>
              <button onClick={() => {setShowSuspendPopup(false);}} className="bg-[#E4572E] w-[121px] h-[35px] text-white rounded">
                Suspend
              </button>
            </div>
          </div>
