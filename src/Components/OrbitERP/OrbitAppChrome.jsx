 ...
 */
export default function OrbitAppChrome({ children, username, onLogout, disabled = false }) {
  ...
  return (
    <>
      <OrbitERPHeading displayName={username || "Admin"} onLogoClick={toggleSidebar} onSignOut={onLogout} />
      {children}
    </>
  );
}
